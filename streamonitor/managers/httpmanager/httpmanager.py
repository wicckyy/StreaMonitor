...
from parameters import WEBSERVER_HOST, WEBSERVER_PORT, WEBSERVER_PASSWORD, WEB_LIST_FREQUENCY, WEB_STATUS_FREQUENCY, \
    WEBSERVER_SKIN, WEBSERVER_PASSWORD_AUTOGENERATED
...
class HTTPManager(Manager):
    def __init__(self, streamers):
        ...
        if WEBSERVER_PASSWORD_AUTOGENERATED and WEBSERVER_PASSWORD != "":
            self.logger.info(f"Auto-generated WEBSERVER_PASSWORD for user 'admin': {WEBSERVER_PASSWORD}")
