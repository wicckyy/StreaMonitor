...
The default username is admin, and a secure random password is auto-generated by default and logged to the console on startup. You can specify a password by setting STRMNTR_PASSWORD in your environment or parameters.py. An empty password is also allowed and disables authentication.
