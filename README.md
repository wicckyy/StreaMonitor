...
If no password is set in parameters.py, a secure random one will be generated. You can explicitly set an empty password in parameters.py to disable authentication. The username is admin.
